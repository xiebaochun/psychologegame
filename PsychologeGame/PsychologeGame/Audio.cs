...
namespace PsychologeGame
{
    ...
    public static class Audio
    {
      ...
      public  static BGMStatus bgmStatus=BGMStatus.Stop;
        ...
        public static void BGSResume(string file)
        {

            bgsInstances[file].Resume();
        }
        public static void BGSStopAll()
        {
            try
            {
                foreach (var bi in bgsInstances)
                {
                    bi.Value.Stop();
                }
                bgmStatus = BGMStatus.Stop;
